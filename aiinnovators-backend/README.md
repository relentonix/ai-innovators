# Welcome, aiinnovators, to the 2023 TDI Global Hackathon
## Contents
...
1. A GCP project (https://console.cloud.google.com/home/dashboard?project=hack-team-aiinnovators)
2. This GitHub repository (https://github.com/db-hackathon/aiinnovators)
3. A Terraform Cloud workspace (https://app.terraform.io/app/db-hackathon-2023/workspaces/hack-team-aiinnovators)
...
## [GCP](https://console.cloud.google.com/home/dashboard?project=hack-team-aiinnovators)
### First log-in
...
8. Navigate to https://console.cloud.google.com/home/dashboard?project=hack-team-aiinnovators.
...
You have an "infrastructure SA" (infrastructure@hack-team-aiinnovators.iam.gserviceaccount.com) with the same IAM permissions as team members.
...
You have a "workload SA" (workload@hack-team-aiinnovators.iam.gserviceaccount.com) that you can use to attach to your workloads (e.g. Cloud Run revisions).
...
you must attach your Workload SA (workload@hack-team-aiinnovators.iam.gserviceaccount.com) , usually referred to in the GCP documentation as "attaching a custom SA".
...
2. Configure your default Cloud Shell Google Cloud Project by running ```gcloud config set project hack-team-aiinnovators```

---
</br>

## [GitHub](https://github.com/db-hackathon/aiinnovators)
...
* vars.INFRA_SA_EMAIL - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-aiinnovators.iam.gserviceaccount.com
* vars.INFRA_SA_ID - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-aiinnovators/serviceAccounts/infrastructure@hack-team-aiinnovators.iam.gserviceaccount.com
* vars.PROJECT_ID - Your team's GCP Project ID.: hack-team-aiinnovators
* vars.PROJECT_NUMBER - Your teams' GCP Project Number.: 429886116942
...
* vars.WORKLOAD_SA_EMAIL - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-aiinnovators.iam.gserviceaccount.com
* vars.WORKLOAD_SA_ID - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-aiinnovators/serviceAccounts/workload@hack-team-aiinnovators.iam.gserviceaccount.com
...
## [Terraform Cloud](https://app.terraform.io/app/db-hackathon-2023/workspaces/hack-team-aiinnovators)
...
* infra_sa_email - The email address representation of the SA you can use to deploy infrastructure. It has the same access rights as human team members.: infrastructure@hack-team-aiinnovators.iam.gserviceaccount.com
* infra_sa_id - The fully qualified ID representation of the SA you can use to deploy infrastructure.: projects/hack-team-aiinnovators/serviceAccounts/infrastructure@hack-team-aiinnovators.iam.gserviceaccount.com
* project_id - Your team's GCP Project ID.: hack-team-aiinnovators
* project_number - Your teams' GCP Project Number.: 429886116942
...
* workload_sa_email - The email address representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : workload@hack-team-aiinnovators.iam.gserviceaccount.com
* workload_sa_id - The fully qualified ID representation of the SA you can attach to your workloads (e.g. to a Cloud Run service). : projects/hack-team-aiinnovators/serviceAccounts/workload@hack-team-aiinnovators.iam.gserviceaccount.com
